    ...
    <div class="all">
        ...
        <div class="container" style="width: 75%;padding-top: 65px;margin-left: 13%; max-width:none;height:auto;margin-bottom:50px;">
            ...
            <div style="display:flex;margin-top: 25px;margin-left: 65px;">
                <div style="display:flex;margin-top: 10px;margin-left: 65px;">
                    <div>
                        ...
                        <div style="display:flex;">
                            <i class="bi bi-clipboard-check" style="font-size: 1.5rem;margin-right: 1rem;"></i>
                            <h4>Başvurulan Fakülte</h4>
                        </div>
                        <div style="display:flex;">
                            <i class="bi bi-clipboard-check" style="font-size: 1.5rem;margin-right: 1rem;"></i>
                            <h4>Başvurulan Bölüm</h4>
                        </div>
                        <div style="display:flex;">
                            <i class="bi bi-clipboard-check" style="font-size: 1.5rem;margin-right: 1rem;"></i>
                            <h4>Öğrenciye ait başvuru belgeleri </h4>

                        </div>
                    </div>
                    <div style="float:inline-end;margin-left: 10px;">
                        <h4>:</h4>
                        <h4>:</h4>
                        <h4>:</h4>
                        <h4>:</h4>
                    ...
                    <div style="color: black;display:flex;margin-left: 35px;">
                        <div style="width: 100%;">
                            ...
                            <div style="display:flex;">
                                <h4><a href="{{$bilgiler['EK1']}}"><button type="button" class="btn btn-light btn-lg" style="width: max-content;">Dil Yeterlilik Belgesi</button></a></h4>
                            </div>
                            <div style="display:flex;">
                                <h4><a href="{{$bilgiler['EK2']}}"><button type="button" class="btn btn-light btn-lg" style="width: max-content;">Transkript</button></a></h4>
                            </div>
                            <div style="display:flex;">
                                <h4><a href="{{$bilgiler['EK3']}}"><button type="button" class="btn btn-light btn-lg" style="width: max-content;">Ders İçerikleri</button></a></h4>
                            </div>
                            <div style="display:flex;">
                                <h4><a href="{{$bilgiler['EK4']}}"><button type="button" class="btn btn-light btn-lg" style="width: max-content;">DGS Başvuru Formu</button></a></h4>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-dialog modal-dialog-centered" style="text-align: center;">
                    {{$bilgiler['ogr_no']}} numaralı öğrencinin DGS başvrusu onaylanacak. Devam etmek istediğinize emin
    ...
    <div class="modal fade" id="reddetModal" tabindex="-1" aria-labelledby="reddetModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-dialog modal-dialog-centered" style="text-align: center;">>
                    {{$bilgiler['ogr_no']}} numaralı öğrencinin DGS reddedilecek. Devam etmek istediğinize emin
                    misiniz?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-bs-dismiss="modal">HAYIR</button>
                    <form method="POST" action="/dgsR?numara=<?php echo $bilgiler['ogr_no'] ?>">
                        @csrf
