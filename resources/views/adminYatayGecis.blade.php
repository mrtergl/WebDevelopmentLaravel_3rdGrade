...
<head>
    ...
    <title>YATAY GEÇİŞ GELEN BAŞVURULAR</title>
...
<body>
    ...
    <div class="title" style="font-size: xx-large;margin-top: 10px;color: green;font-weight: 800;text-align:center;">GELEN BAŞVURULAR
    </div>
    <div class="all">

        @foreach ($degerler as $item)
        @if($item['onayD']=='ONAY BEKLİYOR')
            ...
            <div style="margin-top:20px;text-align:left;color: black;display:flex;margin-left: 10%;">
                <div style="margin-left: 30px;">
                    <div style="display:flex;margin-top: 55px;">
                        <a href="/basvuruInceleYatayGecis?numara=<?php echo $item['ogr_no'] ?>">
                            <button type="button" class="btn btn-info btn-lg" style="width: 10rem;">İncele</button>
                        </a>
                    </div>
                </div>
            </div>
