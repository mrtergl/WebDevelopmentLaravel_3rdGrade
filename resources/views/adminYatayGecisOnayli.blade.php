...
<head>
    ...
    <title>YATAY GEÇİŞ ONAYLANAN BAŞVURULAR</title>
...
<body>
    ...
    <div class="title" style="font-size: xx-large;margin-top: 10px;color: green;font-weight: 800;text-align:center;">ONAYLANAN
        BAŞVURULAR
    </div>
    <div class="all">

        @foreach ($degerler as $item)
        @if($item['onayD']=="ONAYLANDI")
