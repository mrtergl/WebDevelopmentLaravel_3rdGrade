    ...
    <div class="all">
        ...
        <div class="container" style="width: 75%;padding-top: 65px;margin-left: 13%; max-width:none;height:auto;margin-bottom:50px;">
            ...
            <div style="display:flex;margin-top: 25px;margin-left: 65px;">
                ...
                <div style="color:aliceblue;margin-left: 55px;">
                    <div style="display:flex; ">
                        <h3>{{$bilgiler['ogr_no']}}</h3>
                    </div>
                    <div style="display:flex;">
                        <h3>{{$bilgiler['adsoyad']}}</h3>
                    </div>
                    <div style="display:flex;">
                        <h3>Yaz Okulu Başvurusu</h3>
                    </div>
                    <div style="display:flex;">
                        <h3>{{$bilgiler['tarih']}}</h3>
                    </div>
                    <div style="display:flex;">
                        <h3>{{$bilgiler['email']}}</h3>
                    </div>
                    <div style="display:flex;">
                        <h3>{{$bilgiler['tel_no']}}</h3>
                    </div>
                    <div style="display:flex;">
                        <h3>{{$bilgiler['bolum']}}</h3>
                    </div>
                    <div style="display:flex;">
                        <h3>{{$bilgiler['yil']}}</h3>
                    </div>
                    ...
                    <div style="display:flex;">
                        <h3>{{$bilgiler['Bfakulte']}}</h3>
                    </div>
                    <div style="display:flex;">
                        <h3>{{$bilgiler['agno']}}</h3>
                    </div>
                    <div style="display:flex;">
                        <h3><a href="{{$bilgiler['EK1']}}"><button type="button" class="btn btn-light btn-lg">Transkript</button></a></h3>
                    </div>
                    <div style="display:flex;">
                        <h3><a href="{{$bilgiler['EK2']}}"><button type="button" class="btn btn-light btn-lg"> ÖSYM Sınav Sonuç Belgesi</button></a></h3>
                    </div>
                    <div style="display:flex;">
                        <h3><a href="{{$bilgiler['EK3']}}"><button type="button" class="btn btn-light btn-lg">Yabancı Dil Yeterlilik Belgesi</button></a></h3>
                    </div>
                    <div style="display:flex;">
                        <h3><a href="{{$bilgiler['EK4']}}"><button type="button" class="btn btn-light btn-lg">Öğrenci Belgesi</button></a></h3>
                    </div>
                    <div style="display:flex;">
                        <h3><a href="{{$bilgiler['EK5']}}"><button type="button" class="btn btn-light btn-lg">Yatay Geçiş Başvuru Formu</button></a></h3>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-dialog modal-dialog-centered" style="text-align: center;">
                    {{$bilgiler['ogr_no']}} numaralı öğrencinin Yatay Geciş başvrusu onaylanacak. Devam etmek istediğinize emin
                    misiniz? {{$bilgiler['onayD']}}
                </div>
    ...
    <div class="modal fade" id="reddetModal" tabindex="-1" aria-labelledby="reddetModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-dialog modal-dialog-centered" style="text-align: center;">>
                    {{$bilgiler['ogr_no']}} numaralı öğrencinin Yatay Geçiş başvrusu reddedilecek. Devam etmek istediğinize emin
                    misiniz?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-bs-dismiss="modal">HAYIR</button>
                    <form method="POST" action="/yataygecisR?numara=<?php echo $bilgiler['ogr_no'] ?>">
                        @csrf
