...
<body>
  ...
  <div class="all">
    ...
    <div class="container" style="max-height:60cm;margin-left: 30%;">
      <div class="title">Ders İntibak Başvurusu</div>
      <form name="form" method="POST">
        ...
        <div class="user-details">
          ...
          <div class="input-box">
            <label class="details">Önceki Üniversite<span style="color:red">*</span></label>
            <input type="text" name="o_uni" placeholder="Önceki Üniversite" required>
          </div>
          <div class="input-box">
            <label class="details">Önceki Fakülte<span style="color:red">*</span></label>
            <input type="text" name="o_fakulte" placeholder="Önceki Fakülte" required>
          </div>
        </div>
        <div class="button-container">
          <div class="button1">
            <br>
            <input type="submit" value="PDF'e dönüştür">
          </div>
          <div class="button2">
            <br>
            <a href='/dersintibakBELGE?numara=<?php echo $numara ?>'><input type="button" value="Başvuru Belgelerini Yükle"></a>
          </div>
        </div>
      </form>
    </div>
