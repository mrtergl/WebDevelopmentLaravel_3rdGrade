                ...
                <div style="display:flex;margin-top: 10px;margin-left: 65px;">
                    ...
                    <div style="color: black;display:flex;margin-left: 35px;">
                        <div style="width: 330px;">
                            ...
                            <div style="display:flex;">
                                <h4><a href={{$bilgiler['EK3']}}><button type="button" class="btn btn-light btn-lg" style="width: max-content;">Ders İntibak Başvuru Formu</button></a></h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-dialog modal-dialog-centered" style="text-align: center;">
                    {{$bilgiler['ogr_no']}} numaralı öğrencinin Ders İnitbak Başvurusu onaylanacak. Devam etmek istediğinize emin
                    misiniz?
                </div>
    ...
    <div class="modal fade" id="reddetModal" tabindex="-1" aria-labelledby="reddetModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-dialog modal-dialog-centered" style="text-align: center;">>
                    {{$bilgiler['ogr_no']}} numaralı öğrencinin Ders İnitbak Başvurusu reddedilecek. Devam etmek istediğinize emin
                    misiniz?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-bs-dismiss="modal">HAYIR</button>
                    <form method="POST" action="/dersintibakR?numara=<?php echo $bilgiler['ogr_no'] ?>">
                        @csrf
