...
<body>
  ...
  <div class="all">
    ...
    <div class="container" style="max-height:60cm;margin-left: 30%;">
      <div class="title">ÇAP Başvurusu</div>
      <form method="POST" name="form">
        ...
        <div class="user-details">
          ...
          <div class="select">
            <label class="details">Kendi Fakülteniz<span style="color:red">*</span></label>
          ...
          <div class="select">
            <label class="details">Kendi Bölümünüz<span style="color:red">*</label>
          ...
          <div class="input-box">
            ...
            <input type="text" name="bas_fakulte" placeholder="Başvurulacak Fakülte" required>
          </div>
          <div class="input-box">
            <label class="details">Başvurulacak Bölüm<span style="color:red">*</span></label>
            <input type="text" name="bas_bolum"  placeholder="Başvurulacak Bölüm" required>
          </div>
        </div>
        <div class="button-container">
          ...
          <div class="button2">
            <br>
            <a href='/capbasvuruBELGE?numara=<?php echo $numara ?>'><input type="button" value="Başvuru Formu Yükle"></a>
          </div>
        </div>
      </form>
    </div>
