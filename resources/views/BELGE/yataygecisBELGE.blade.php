...
<body>
 ...
 <div class= "all">
    ...
    <div class="title">Yatay Geçiş Başvurusu Belge Yükleme</div>
    <br>
    <form  method="POST" enctype="multipart/form-data">
        ...
        <div class="belge-container">
            <label>EK 2 : ÖSYM Sınav Sonuç belgesinin İnternet çıktısı</label>
            <input type="file" name="EK2" id="EK2" accept="application/pdf" required>
        </div>
        <div class="belge-container">
            <label>EK 3 : Yabancı  Dil  Hazırlık  veya  Yeterlik  belgesi</label>
            <input type="file" name="EK3" id="EK3" accept="application/pdf" required >
        </div>
        <div class="belge-container">
            <label>EK 4 : Öğrenci belgesi</label>
            <input type="file" name="EK4" id="EK4" accept="application/pdf" required>
        </div>
        <div class="belge-container">
            <label>EK 5 : Yatay Geçiş Başvuru Formu</label>
