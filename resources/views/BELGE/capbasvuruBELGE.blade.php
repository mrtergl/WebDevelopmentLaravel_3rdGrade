...
<body>
 ...
 <div class= "all">
    ...
    <div class="title">Çift Anadal Başvurusu Belge Yükleme</div>
    <br>
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="belge-container">
            ...
            <input type="file" name="EK2" id="EK2" accept="application/pdf" >
        </div>
        <div class="belge-container">
            <label>EK 3 : ÇAP Başvuru Formu</label>
            <input type="file" name="EK3" id="EK3" accept="application/pdf" >
        </div>
        <br><br>
        <div class="button-container">
            <div class="button1">
                <input type="submit" value="Başvuruyu Tamamla" onclick="git()">
            </div>
        </div>
        <br><br><br>
    </form>
