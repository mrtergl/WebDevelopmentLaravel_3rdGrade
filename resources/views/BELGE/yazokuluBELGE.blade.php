...
<body>
 ...
 <div class= "all">
    ...
    <div class="title">Yaz OKulu Başvurusu Belge Yükleme</div>
    <br>
    <form  method="POST" enctype="multipart/form-data">
        ...
        <div class="belge-container">
            <label>EK 2 : Öğrencinin üniversiteye giriş yılındaki taban puanını gösteren belge</label>
            <input type="file" name="EK2" id="EK2" accept="application/pdf" required>
        </div>
        <div class="belge-container">
            <label>EK 3 : Alınmak istenilen derslerin ders saati/kredi/AKTS,ders içeriklerini gösteren belge </label>
            <input type="file" name="EK3" id="EK3" accept="application/pdf" required >
        </div>
        <div class="belge-container">
            <label>EK 4 : Yaz Öğretim boyunca sorumlu olunan dersler</label>
            <input type="file" name="EK4" id="EK4" accept="application/pdf" required>
        </div>
        <div class="belge-container">
            <label>EK 5 : Yaz Okulu Başvuru Formu</label>
            <input type="file" name="EK5" id="EK5" accept="application/pdf" required>
        </div>
        <br><br>
