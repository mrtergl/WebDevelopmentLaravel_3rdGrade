...
<body>
    ...
    <div class="title" style="font-size: xx-large;margin-top: 10px;color: green;font-weight: 800;text-align:center;">REDDEDİLEN
        BAŞVURULAR
    </div>
    <div class="all">
        ...
        <div class="basvuruTakip" style="display: flex;">
            ...
            <div style="margin-top:20px;text-align:left;color: black;display:flex;margin-left: 15%;">
                <div style="display:flex;margin-top: 45px;height: 50px;margin-left:25px;">
                    <a href="/adminBasvuruIncele?numara=<?php echo $item['ogr_no'] ?>">
                        <button type="button" class="btn btn-info btn-lg" style="width: 15rem;">İncele</button>
                    </a>
                </div>
            </div>
        </div>
